...
public class V_Beres_Data_BanyakPinjaman extends javax.swing.JFrame {

    /**
     * Creates new form V_Beres_Data_BanyakPinjaman
     */
    Connection koneksi;
    String getTglPinjam, getNama, Berdasarkan, Tahun, BanyakPeminjaman;
    String kolom[] = {"No", "Nama Peminjam", "Banyak Pinjaman"};
    C_Anggota Anggota = new C_Anggota();
    C_Peminjaman Pinjam = new C_Peminjaman();

    public V_Beres_Data_BanyakPinjaman() {
        initComponents();
...
//FORM
    ...
    public void TampilPerBulan() {
        ...
        try {
            ...
            while (rs.next()) {
                BanyakPeminjaman = rs.getString("BanyakPeminjaman");
                Anggota.setNmAnggota(rs.getString("Nama_Anggota"));
                getNama = Anggota.getNmAnggota();
                dtm.addRow(new String[]{"" + No, getNama, BanyakPeminjaman});
                No = No + 1;
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(V_Beres_Data_BanyakPinjaman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new V_Beres_Data_BanyakPinjaman().setVisible(true);
            }
        });
    }
