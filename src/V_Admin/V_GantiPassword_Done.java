 ...
 * @author Fauzanlh
 */
public class V_GantiPassword_Done extends javax.swing.JFrame {

    /**
     * Creates new form V_GantiPassword_Done
     */
    Connection koneksi;

    public V_GantiPassword_Done() {
        initComponents();
    ...
    public void UbahPassword() {
        ...
        try {
            ...
            if (!User.equals("") && !Pass.equals("")) {
                String SqlUbahPassword = "UPDATE T_Master SET Password = '" + Pass + "' WHERE Username = '" + User + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(V_GantiPassword_Done.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new V_GantiPassword_Done().setVisible(true);
            }
        });
    }
