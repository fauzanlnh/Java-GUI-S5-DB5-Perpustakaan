 ...
 * @author Fauzanlh
 */
public class V_Data_Kategori extends javax.swing.JFrame {

    /**
     * Creates new form V_Data_Kategori
     */
    Connection koneksi;

    public V_Data_Kategori() {
        initComponents();
    ...
    public void showData() {
        ...
        try {
            ...
            int no = 1;
            while (rs.next()) {
                String Kd_Kategori = rs.getString("Kd_Kategori");
                String Nama_Kategori = rs.getString("Nama_Kategori");
                tableModel.addRow(new String[]{no + "", Kd_Kategori, Nama_Kategori});
                no++;
            }
        } catch (Exception ex) {
    ...
    public void Move() {
        String Kd_Kategori = tblKategori.getValueAt(tblKategori.getSelectedRow(), 1).toString();
        String Nama_Kategori = tblKategori.getValueAt(tblKategori.getSelectedRow(), 2).toString();
    ...
    public void SimpanData() {
        ...
        try {
            ...
            if (!KdKategori.equals("") && !NamaKategori.equals("")) {
                String SqlUbahPassword = "UPDATE t_Kategori_koleksi SET Nama_kategori = '" + NamaKategori + "' WHERE Kd_Kategori = '" + KdKategori + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(V_Data_Kategori.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new V_Data_Kategori().setVisible(true);
            }
        });
    }
