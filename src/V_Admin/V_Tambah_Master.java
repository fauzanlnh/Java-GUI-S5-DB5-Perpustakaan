 ...
 * @author Fauzanlh
 */
public class V_Tambah_Master extends javax.swing.JFrame {

    /**
     * Creates new form V_Tambah_Master
     */
    Connection koneksi;

    public V_Tambah_Master() {
        initComponents();
    ...
    public void SimpanData() {
        ...
        String Hak = cmbHakAkses.getSelectedItem().toString().toUpperCase();
        try {
            Statement stmt = koneksi.createStatement();
            if (!User.equals("") && !Pass.equals("") && !Hak.equals("-")) {
                String SqlUbahPassword = "INSERT INTO T_Master VALUES('" + User + "','" + Pass + "','" + Hak + "')";
    ...
    private void initComponents() {
        ...
        FormUbah.getAccessibleContext().setAccessibleName("Tambah User");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(V_Tambah_Master.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new V_Tambah_Master().setVisible(true);
            }
        });
    }
