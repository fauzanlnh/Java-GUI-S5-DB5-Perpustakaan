 ...
 * @author Fauzanlh
 */
public class V_Anggota_Done extends javax.swing.JFrame {

    /**
     * Creates new form V_Anggota_Done
     */
    Connection koneksi;

    public V_Anggota_Done() {
        initComponents();
    ...
    public void TambahAnggota() {
        String KdAnggota = txtKodeAnggota.getText().toUpperCase();
        String NamaAnggota = txtNamaAnggota.getText().toUpperCase();
        String Status = cmbStatus.getSelectedItem().toString().toUpperCase();
        String Email = txtEmail.getText().toLowerCase();
        if (KdAnggota.equals("") && NamaAnggota.equals("") && Status.equals("-") && Email.equals("")) {
            JOptionPane.showMessageDialog(null, "FORM BELUM DI ISI");
            txtKodeAnggota.requestFocus();
        } else if (KdAnggota.equals("")) {
            JOptionPane.showMessageDialog(null, "KODE ANGGOTA BELUM DI ISI");
            txtKodeAnggota.requestFocus();
        } else if (NamaAnggota.equals("")) {
            ...
            try {
                ...
                String TambahAnggota = "INSERT INTO T_Anggota VALUES"
                        + "('" + KdAnggota + "','" + NamaAnggota + "','" + Status + "','" + Email + "')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(V_Anggota_Done.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new V_Anggota_Done().setVisible(true);
            }
        });
    }
